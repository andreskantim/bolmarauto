...
grid_parametros = [

    {
        ...
        'regressor__epsilon': [0.01, 0.1, 0.2, 1],
        'regressor__degree': [2],  #aqui si que puede subirse a 3
        # 'regressor__gamma': ['scale', 'auto'],
        # 'regressor__coef0': [0.0, 0.1, 0.5],  # Término independiente para kernel polinomial
    }
