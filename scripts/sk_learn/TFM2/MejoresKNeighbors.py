...
output_file = "../../predicciones/modelo/FQXX41MM/cantabria_KNN.csv"
best_results_csv = "../../scripts/sk_learn/TFM2/resultados/KN_resultados.csv"
...
for col in target.columns:  
    ...
    result_data = {
        ...
        'csv_row': {
            ...
            'metric': best_params['regressor__metric'],
            'best_score': grid_search.best_score_
        }
    }
