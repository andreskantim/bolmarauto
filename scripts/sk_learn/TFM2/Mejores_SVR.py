...
output_file = "../../predicciones/modelo/FQXX41MM/cantabria_SVR.csv"
best_results_csv = "../../scripts/sk_learn/TFM2/resultados/SVR_resultados.csv"
...
grid_parametros = [
    ...
    'pca': [PCA(n_components=0.95), PCA(n_components=0.90)],
...
for col in target.columns:  
    ...
    result_data = {
        ...
        'csv_row': {
            'variable': col,
            'regressor': 'SVR',
            'scaler': type(best_params['scaler']).__name__,
            'pca_components': best_params['pca'].n_components,
